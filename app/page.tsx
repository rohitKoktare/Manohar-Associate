...
export default function ManorAssociatesWebsite() {
  ...
  const services = [
    {
      ...
      description:
        "Disputes relating to contracts, property, recovery, injunctions, and other civil remedies before trial and appellate courts.",
    ...
    },
    {
      ...
      description:
        "Legal representation in divorce, maintenance, domestic violence, child custody, and family property settlements under Hindu, Muslim, and Special Marriage Acts.",
    ...
    },
    {
      ...
      title: "Criminal Law",
      description:
        "Defence in bail matters, anticipatory bail, white-collar offences, quashing of FIRs, and trial representation under IPC and allied criminal laws.",
    ...
    },
    {
      ...
      description:
        "Advisory and litigation in matters involving SEBI regulations, insider trading, SAT appeals, financial misconduct, and investor protection laws.",
    ...
    },
    {
      ...
      description:
        "Representation in cases of service deficiency, builder-buyer disputes, and product liability before Consumer Commissions at all levels.",
      color: "bg-purple-50 text-purple-600",
    },
    {
      icon: UserCheck,
      title: "Property & RERA Legal Services",
      description:
        "Due diligence, title verification, redevelopment disputes, RERA complaints for delayed possession, and claims for compensation and interest.",
      color: "bg-purple-50 text-purple-600",
    },
  ];
  ...
  const values = [
    {
      icon: Shield,
      title: "Integrity",
      description: "Ethical advocacy in every case",
    },
    {
      icon: Award,
      title: "Excellence",
    ...
    },
    {
      ...
      description: "Personalized legal strategy for every client",
    },
    {
      icon: Scale,
      title: "Transparency",
      description: "Clear, honest communication",
    },
  ];
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Essential legal steps and precautions to safeguard your interests during divorce proceedings in India.",
    ...
    },
    {
      ...
      excerpt:
        "Complete guide to filing SEBI complaints, investor protection mechanisms, and regulatory procedures.",
    ...
    },
    {
      ...
      excerpt:
        "How proper legal counsel can accelerate startup growth and prevent costly legal pitfalls.",
...
"मी सहमत आहे" या बटणावर क्लिक करून, आपण वरील अटी समजून घेतल्या आहेत आणि आपण स्वतःहून पुढे जात आहात हे आपण मान्य करता।`,
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-4 sm:p-6">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-lg sm:text-xl">
              ...
              {
                disclaimerContent[
                  disclaimerLanguage as keyof typeof disclaimerContent
                ].title
              }
            </DialogTitle>
          </DialogHeader>
          ...
          <Tabs
            ...
            onValueChange={setDisclaimerLanguage}
            className="w-full"
          >
      ...
      <section
        id="home"
        className="bg-gradient-to-br from-slate-50 to-amber-50 py-20"
      >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-slate-800 mb-6 leading-tight">
                Welcome to{" "}
                <span className="text-amber-600">Manor & Associates</span>
              </h1>
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                At Manor & Associates, we combine legal excellence with
                client-focused service. Founded by Advocate Arvind Manor, our
                firm is committed to providing strategic, solution-oriented
                legal counsel across a wide range of practice areas. Whether
                you're an individual or a business, our dedicated team will
                stand by your side to protect your rights and interests.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Manor & Associates is a full-service law firm based in Pune,
              Maharashtra, serving clients across India. With years of
              experience and a reputation for integrity, Advocate Arvind Manor
              leads a team dedicated to upholding the highest standards of legal
              practice.
            </p>
          </motion.div>
              ...
              <Card className="border-2 border-amber-100">
                ...
                <CardContent>
                  <p className="text-slate-600 mb-4">
                    A respected member of the Pune Bar Association, Arvind Manor
                    brings a wealth of legal and financial expertise to every
                    case. His commitment to ethical practice and client success
                    has established Manor & Associates as a trusted name in
                    legal services. With specialization in SEBI matters and
                    corporate law, he has successfully represented numerous
                    clients in complex financial disputes.
                  </p>
      ...
      <section id="services" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              At Manor & Associates, we offer expert legal solutions across the
              following domains:
            </p>
          </motion.div>
            ...
            {services.map((service, index) => (
              <motion.div key={index} variants={fadeInUp} {...scaleOnHover}>
                <Card className="h-full hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                  <CardHeader>
                    <div
                      className={`inline-flex p-3 rounded-full mb-4 ${service.color} flex-row items-center space-x-3`}
                    >
      ...
      <section id="blogs" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Stay informed about your legal rights and responsibilities with
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Get in touch with our legal experts for a consultation. We're
              committed to providing you with the best legal representation.
            </p>
          </motion.div>
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Providing strategic, solution-oriented legal counsel across a
                wide range of practice areas since 2010.
              </p>
            </div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center">
            <p className="text-slate-400 text-sm">
              © {new Date().getFullYear()} Manor & Associates. All rights
              reserved. | Website designed with excellence for legal
              professionals.
            </p>
          </div>
        </div>
